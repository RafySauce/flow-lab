...
| Inputs and grounding | Body: name the source-repo paths to read; state the no-fabrication rules |
...
2. Emitted files go to the **source-repo** (or the product repo the skill serves), through normal MR/PR review — the foundry emits, a human merges.
